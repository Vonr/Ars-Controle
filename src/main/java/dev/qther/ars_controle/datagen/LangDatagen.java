...
public class LangDatagen extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("ars_controle.page1.remote", "The Remote lets you remotely configure blocks and entities that the Dominion Wand can. To use it, first crouch and use it on the thing you would like to configure. Then, you can use it again on other blocks or entities depending on what the block you are configuring accepts.");
        add("ars_controle.page2.remote", "When you are done, left clicking the air will clear its target. The remote allows for cross dimensional configuration of the Warping Spell Prism, unlike the Dominion Wand.");

        add("ars_controle.page1.portable_brazier_relay", "The Portable Brazier Relay allows you to carry the effects of a ritual on you. This requires the ritual brazier to stay loaded and have a supply of source.");
