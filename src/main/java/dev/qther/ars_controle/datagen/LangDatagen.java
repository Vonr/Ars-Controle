...
public class LangDatagen extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("ars_nouveau.page1.block.ars_controle.scroll_holder", "The Warp Scroll Holder allows you to easily open and close warp portals to your desired destinations. Simply replace one of your portal frames with a Warp Scroll Holder in an appropriate direction and insert a Warp Scroll with some Source nearby.");
